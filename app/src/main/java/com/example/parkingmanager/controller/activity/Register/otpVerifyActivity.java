...
import com.example.parkingmanager.controller.activity.StartActivity;
...
public class otpVerifyActivity extends AppCompatActivity {
    ...
    EditText et_no1 = findViewById(R.id.et_otp_num1);
    EditText et_no2 = findViewById(R.id.et_otp_num2);
    EditText et_no3 = findViewById(R.id.et_otp_num3);
    EditText et_no4 = findViewById(R.id.et_otp_num4);
    EditText et_no5 = findViewById(R.id.et_otp_num5);
    EditText et_no6 = findViewById(R.id.et_otp_num6);
    Button mOtp_verify_btn = findViewById(R.id.btn_phone_verify_next);
    Button mResend_btn = findViewById(R.id.btn_otp_resend);
    Button mChange_no_btn = findViewById(R.id.btn_otp_change_number);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String Mobile_no = parkingManager.Mobile_no;
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if(task.isSuccessful())
                    {
                        ...
                        UserdataMap.put("Name",parkingManager.Person_name);
                        UserdataMap.put("Mobile_no",parkingManager.Mobile_no);
...
//                        edit.apply();
 ...
 //                       FirebaseMessaging.getInstance().addOnCompleteListener(instanceIdResult -> {
 ...
 //                       });
                        ...
                        if (task.getResult().getAdditionalUserInfo().isNewUser()) {
                            mUserDatabase.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("Profile").setValue(UserdataMap).addOnCompleteListener(task1 -> {
                                ...
                                {
                                    Intent profileIntent = new Intent(otpVerifyActivity.this, StartActivity.class);
